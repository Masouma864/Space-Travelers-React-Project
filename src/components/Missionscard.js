const Missionscard = () => (
    <tr>
        ...
        <td >Thaicom is the name of a series of communications satellites
            ...
            The satellite projects were named Thaicom by the King of Thailand, His Majesty
            the King Bhumibol Adulyadej,as a symbol of the linkage between Thailand and modern communications technology.</td>
        <td>
